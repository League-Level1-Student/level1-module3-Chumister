...
JPanel Frank = createHeader("Welcome to Jeopardy");
...
if (buttonPressed==firstButton) {
	askQuestion("What is the first Pokemon ever made?", "Rhydon", 200);
...
if (buttonPressed==secondButton) {
	askQuestion("What is second first Pokemon seen in the anime", "Charizard", 400);
}
...
if (question==correctAnswer) {
	prizeMoney++;
	JOptionPane.showConfirmDialog(null, "You are correct!");
	updateScore();
}
		// Increase the score by the prizeMoney
else {
	prizeMoney--;
	JOptionPane.showConfirmDialog(null, "You are incorrect it is"+correctAnswer);
updateScore();
}
